...
## Current state
- Milestone: bản gốc `publish-1.0.25`; bản GPU `publish-2.0.0-gpu`; bản tối ưu `publish-2.1.1-opt` (hàng đợi giữ sau khi đóng app).
...
## Next step
- Chạy `publish-2.1.1-opt\VideoAutoTool.App.exe`. Đóng khi đang có hàng đợi, mở lại phải thấy list; bấm **Render tiếp**.
